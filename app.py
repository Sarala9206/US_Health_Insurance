...
from us_insurance.constants import APP_HOST, APP_PORT
from us_insurance.pipline.prediction_pipeline import USinsuranceData, USinsuranceClassifier
from us_insurance.pipline.training_pipeline import TrainPipeline
...
class DataForm:
    ...
    async def get_usinsurance_data(self):
...
async def index(request: Request):
    ...
    return templates.TemplateResponse(
            "usinsurance.html",{"request": request, "context": "Rendering"})
...
async def predictRouteClient(request: Request):
    try:
        ...
        usvisa_df = usinsurance_data.get_usvisa_input_data_frame()

        model_predictor = USinsuranceClassifier()
